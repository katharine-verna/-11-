...
QT_MOC_LITERAL(1, 11, 11), // "RhyGameQuit"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "keyPressEvent"
QT_MOC_LITERAL(4, 38, 10), // "QKeyEvent*"
QT_MOC_LITERAL(5, 49, 5), // "event"
QT_MOC_LITERAL(6, 55, 15) // "keyReleaseEvent"

    },
    "GameWidget\0RhyGameQuit\0\0keyPressEvent\0"
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::RhyGameQuit)) {
                *result = 0;
                return;
            }
        }
